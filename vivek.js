...
vivekmasonaDownDiv.style.height="auto";
vivekmasonaDownDiv.style.width="80%";
vivekmasonaDownDiv.style.maxHeight="40%";
...
vivekmasonaDownDiv.style.padding="20px";
vivekmasonaDownDiv.style.borderRadius="5px";
vivekmasonaDownDiv.style.color="white";
vivekmasonaDownDiv.style.textAlign="center";
vivekmasonaDownDiv.innerHTML="<style>#downvivekmasonadiv a{text-decoration:none;color:white;} #downvivekmasonadiv li{list-style:none;color:#0dd;padding:10px;background:#fff;border:1px solid silver;margin:5px;text-align:lft;}</style>";
vivekmasonaDownDiv.innerHTML+="<span style='position:absolute;top:15px;left:15px;color:#04C5B9;font-size:30px;' onclick='"+"this.parentElement.parentElement.style.display="+'"'+"none"+'"'+";'>&#x2715;</span><a href='https://pgmoviepro.blogspot.com/'><img src='https://i.ibb.co/j6JQcZy/images-4.png' /></a><ul id='listurl'>";
